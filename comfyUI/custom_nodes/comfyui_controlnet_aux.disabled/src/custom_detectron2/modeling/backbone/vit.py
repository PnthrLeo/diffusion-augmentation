...
from custom_detectron2.layers import CNNBlockBase, Conv2d, get_norm
from custom_detectron2.modeling.backbone.fpn import _assert_strides_are_log2_contiguous
