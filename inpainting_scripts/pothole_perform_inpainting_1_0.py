...
if __name__ == '__main__':
    ...
    pipeline_path = 'batch_inpainting_SDXL_refiner_controlnet-v1.2-p-ready-no-depth-pothole-api.json'
    ...
    for part_idx in range(len(images_paths)):
        ...
        positive_prompts = ['a photo of a dry road, (((ultrarealistic))), hdr, 8k',
                            'a photo of a rainy road, (((ultrarealistic))), hdr, 8k',
                            'a photo of a showy road (((ultrarealistic))), hdr, 8k']
