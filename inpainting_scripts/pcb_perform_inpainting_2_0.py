...
if __name__ == '__main__':
    ...
    pipeline_path = 'batch_inpainting_SDXL_refiner_controlnet-v2.0-p-ready-no-depth-pcb-api.json'
...
for part_idx in range(len(images_paths)):
    ...
    # set inpainting images saver path v3
    ...
    positive_prompts = ['a photo of a printed circuit board, (((ultrarealistic))), hdr, 8k']
